...
function setup() {
  ...
  manStand.setCollider("rectangle",0,0,70,70);
      manStand.debug = true;
      console.log("yup!!!") ;

      enemy40.setCollider("rectangle",0,0,70,70);
      enemy40.debug = true;
      console.log("yup!!!")
   ...
   if(enemy5.isTouching(manStand) ) {
    ...
    if(enemy40.isTouching(manStand)){
     ...
     enemy40.scale = 2
      ...
      manStand.keyWentDown(RIGHT_ARROW) = false ;
    ...
    if(enemy40.isTouching(manStand)){
      ...
      textSize(20)
      fill("black");
      text("CONGRATULATIONS YOU WON",700 , 250)

      console.log("text")
    }
    

   /* if(manStand.isTouching(enemy1)){
      manStand.destroy();
      bulletGroup.destroyEach();
      gameOver = createSprite(800 , 500 , 20 , 20);
      gameOver.addImage(gameOverImg);
